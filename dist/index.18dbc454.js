...
"use strict";
/*Variables*/ let API_Key = "563492ad6f9170000100000197b3f2ff2de44d0f8b46fa4f7b03d27b";
const gallery = document.getElementById("gallery");
let fetchLink;
/*Functions*/ window.onload = init();
function init() {
    console.log("Getting images from Pexels API..");
    curatedPhotos();
}
/*Fetching API Function*/ async function fetchAPI(url) {
...
function generatePictures(data) {
    data.photos.forEach((photo)=>{
        ...
        /*Classname for styling */ galleryImg.classList.add("gallery-img");
